    ...
    <PageContainer scrollable>
      <div className="space-y-4">
        <div className="flex items-start justify-between">
          <Heading
            title={`Data Principals (${totalCount})`}
            description="Manage registered Data Principals and enforce DPDP privacy governance"
          />
          ...
          >
            <Plus className="mr-2 h-4 w-4" /> Add Data Principal
          </Link>
        </div>
        <Separator />
